...
function Humid() {
  ...
  function setCardInPlane(timetoStart, moisture, duration, relayId, row) {
    var tbody = document.getElementById("cases-humid");
...
const getData = () => {
  fetch("http://localhost:8080/api/SetAirMoisture")
  ...
  const delData = (int) => {
    ...
    fetch("http://localhost:8080/api/SetAirMoisture/AirMoistureByContext" , {method: 'DELETE',
      headers: {
